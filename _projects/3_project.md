...
<div class="mt-4">
    <a href="../../assets/pdf/report_NML.pdf" class="btn btn-primary" target="_blank">
        View Report 
    </a>
</div>

<div class="mt-4">
    <a href="https://github.com/mehdi533/neurograph-seizure" class="btn btn-primary" target="_blank">
        View Code 
    </a>
</div>
