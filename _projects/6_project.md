...
<div class="mt-4">
    <a href="../../assets/pdf/DIS_Project_2.pdf" class="btn btn-primary" target="_blank">
        View Report
    </a>
</div>

<div class="mt-4">
    <a href="https://github.com/AryanAhadinia/DIS-project-2" class="btn btn-primary" target="_blank">
        View Code
    </a>
</div>
